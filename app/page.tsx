...
export default function HomePage() {
  ...
  const [policyMeta, setPolicyMeta] = useState<{ pages?: number; chars: number }>({
  ...
  const handlePolicyUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setPolicyMeta({ pages: data.pages, chars: data.characters });
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{ color: "#8B7355" }}
                  >
                    {policyMeta.pages ? `${policyMeta.pages}pp · ` : ""}
